...
// SetConditionCompiler overrides the CEL condition compiler (used for matchConditions).
func (a *Webhook) SetConditionCompiler(compiler cel.ConditionCompiler) {
	if compiler != nil {
		a.filterCompiler = compiler
	}
}
